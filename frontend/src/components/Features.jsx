    ...
    <section className="py-20 relative">
      <div className="max-w-6xl mx-auto px-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
            ...
            <div
              key={index}
              className="group rounded-2xl border border-white/10 bg-white/5 backdrop-blur p-8 transition-all duration-300 cursor-pointer relative overflow-hidden hover:-translate-y-2 hover:shadow-lg"
            >
              ...
              <p className="text-base text-gray-300 leading-relaxed mb-0">{feature.description}</p>
        ...
        <div ref={statsRef} className="mt-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <div
                key={index}
                className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 text-center border border-white/20 transition-all duration-300 hover:bg-white/20 hover:scale-105"
              >
