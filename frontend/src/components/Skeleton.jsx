...
export default function Skeleton({ variant = 'card', count = 1 }) {
  const Card = () => (
    <div className="mx-auto w-full max-w-sm rounded-md border border-white/10 bg-slate-950 p-4">
        ...
        <div className="flex-1 space-y-6 py-1">
          ...
          <div className="space-y-3">
            <div className="grid grid-cols-3 gap-4">
              <div className="col-span-2 h-2 rounded bg-white/10"></div>
              <div className="col-span-1 h-2 rounded bg-white/10"></div>
            </div>
            <div className="h-2 rounded bg-white/10"></div>
          </div>
        </div>
  ...
  const ListItem = () => (
    <div className="w-full p-4 border border-white/10 rounded-md bg-slate-950 animate-pulse">
  ...
  const GridCard = () => (
    <div className="rounded-lg overflow-hidden shadow-sm border border-white/10 bg-slate-950 p-0">
