...
const QuizzesPage = () => {
                ...
                <div className="relative overflow-hidden">
                    ...
                    <div className="flex items-center justify-center min-h-[calc(100vh)] p-4">
                        <div className="text-center">
                            <div className="w-20 h-20 bg-gradient-to-r from-teal-400 to-teal-600 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-2xl animate-bounce">
                                <Loader2 className="h-10 w-10 animate-spin text-white" />
                            </div>
                            <p className="text-2xl text-white font-medium">Loading amazing quizzes...</p>
                    ...
                    <div className="text-center max-w-md">
                        <div className="bg-red-500/20 backdrop-blur-xl border border-red-500/30 rounded-2xl p-8 shadow-2xl">
                            ...
                            <button 
                                ...
                                className="px-6 py-3 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-xl hover:from-red-600 hover:to-red-700 transition-all duration-300 transform hover:scale-105 shadow-lg"
                            >
                                Try Again
                            </button>
                        </div>
    ...
    return (
        <div className="flex-grow bg-gradient-to-br from-slate-900 via-teal-900 to-slate-900 min-h-screen">
            {/* 3D Background Pattern */}
            <div className="fixed inset-0 overflow-hidden pointer-events-none">
                <div className="absolute -top-40 -right-40 w-80 h-80 bg-gradient-to-r from-teal-400/20 to-purple-600/20 rounded-full blur-3xl animate-pulse"></div>
                <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-gradient-to-r from-blue-400/20 to-teal-600/20 rounded-full blur-3xl animate-pulse delay-1000"></div>
                ...
                {/* Geometric shapes */}
                <div className="absolute top-20 left-10 w-4 h-4 bg-teal-400 rotate-45 animate-ping"></div>
                <div className="absolute top-40 right-20 w-6 h-6 bg-purple-400 rounded-full animate-ping delay-500"></div>
                <div className="absolute bottom-40 left-20 w-3 h-3 bg-blue-400 rotate-45 animate-ping delay-1000"></div>
                <div className="absolute bottom-20 right-40 w-5 h-5 bg-pink-400 rounded-full animate-ping delay-1500"></div>
            </div>
                    ...
                    {!selectedQuizId ? (
                        <section className="p-6 md:p-8 lg:p-12">
                            <div className="text-center mb-16">
                                <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r from-teal-400 to-teal-600 rounded-2xl mb-6 shadow-2xl">
                                    <GraduationCap className="h-10 w-10 text-white" />
                                </div>
                                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 bg-gradient-to-r from-teal-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">
                                    Explore CSE Quizzes
                                </h1>
                            ...
                            <div className="mb-16 p-8 bg-gradient-to-r from-teal-500/20 to-teal-600/20 backdrop-blur-xl rounded-2xl border border-teal-400/30 shadow-2xl">
                                <div className="max-w-3xl mx-auto">
                                    <div className="text-center mb-6">
                                        <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-teal-500 to-pink-600 rounded-xl mb-4 shadow-xl">
                                            <SparklesIcon className="h-8 w-8 text-white" />
                                        </div>
                                        <h2 className="text-2xl font-bold text-white mb-2">Generate Custom Quiz with AI</h2>
                                        <p className="text-gray-300">Create personalized quizzes on any topic using artificial intelligence</p>
                                    </div>
                                    <div className="flex flex-col sm:flex-row gap-4">
                                        <input
                                            ...
                                            className="flex-1 px-6 py-4 rounded-xl border border-white/20 bg-white/20 backdrop-blur-sm focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all disabled:bg-gray-800/50 disabled:cursor-not-allowed text-white placeholder-gray-400"
                                        />
                                        <button
                                            onClick={handleGenerateCustomQuiz}
                                            disabled={isGeneratingQuiz || !customTopic.trim() || !currentUser}
                                            className="px-8 py-4 bg-gradient-to-r from-teal-600 to-pink-600 text-white rounded-xl hover:from-teal-700 hover:to-green-700 disabled:from-teal-600 disabled:to-teal-700 disabled:cursor-not-allowed transition-all duration-300 flex items-center gap-3 justify-center min-w-fit transform hover:scale-105 shadow-xl"
                                        >
                                            {isGeneratingQuiz ? (
                                                <>
                                    ...
                                    {!currentUser && !generationError && (
                                        <div className="mt-4 p-4 bg-amber-500/20 border border-amber-500/30 rounded-xl backdrop-blur-sm">
                                            <p className="text-amber-300">Login to generate custom quizzes with AI.</p>
                                        </div>
                                    )}
                                </div>
                            </div>
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div className="relative z-10">
                                                <div className={`inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br ${themeClass} rounded-2xl mb-6 group-hover:scale-110 transition-transform duration-300 shadow-xl`}>
                                                    {IconComponent && <IconComponent className="h-8 w-8 text-white" />}
                                                </div>
                                                <h3 className="text-2xl font-bold text-white mb-3 group-hover:text-teal-300 transition-colors">{quiz.title}</h3>
                        ...
                        <section className="min-h-[600px]">
                            {/* Header */}
                            <div className="bg-gradient-to-r from-teal-500/20 to-purple-600/20 backdrop-blur-xl px-8 py-6 border-b border-white/10">
                                <div className="flex items-center gap-6">
                                    <button
                                        onClick={handleBackToQuizzes}
                                        className="flex items-center gap-3 px-6 py-3 text-white/80 hover:text-white hover:bg-white/10 rounded-xl transition-all duration-300 transform hover:scale-105"
                                    >
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-300 mt-1">Challenge yourself and learn something new</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="p-8 md:p-12 lg:p-16">
                                {showResults ? (
                                    <div className="max-w-3xl mx-auto text-center">
                                        <div className="bg-gradient-to-br from-emerald-500/20 to-teal-500/20 backdrop-blur-xl rounded-3xl p-12 border border-emerald-400/30 shadow-2xl">
                                            <div className="w-24 h-24 bg-gradient-to-r from-emerald-400 to-teal-500 rounded-full flex items-center justify-center mx-auto mb-8 shadow-2xl animate-bounce">
                                            ...
                                            <div className="mb-8">
                                                ...
                                                <div className="w-full bg-white/20 rounded-full h-4 mb-4">
                                                    <div 
                                                        className="bg-gradient-to-r from-teal-400 to-emerald-500 h-4 rounded-full transition-all duration-1000"
                                            ...
                                            {!currentUser && (
                                                <div className="mb-8 p-6 bg-yellow-500/20 border border-yellow-500/30 rounded-2xl backdrop-blur-sm">
                                            ...
                                            <button
                                                ...
                                                className="px-8 py-4 bg-gradient-to-r from-teal-600 to-emerald-600 text-white rounded-xl hover:from-teal-700 hover:to-emerald-700 transition-all duration-300 transform hover:scale-105 shadow-xl"
                                            >
                                                🔄 Restart Quiz
                                            </button>
                                        </div>
                                    ...
                                    <div className="max-w-5xl mx-auto">
                                        ...
                                        <div className="mb-12">
                                            ...
                                            <div className="w-full bg-white/20 rounded-full h-3 overflow-hidden">
                                                <div 
                                                    className="bg-gradient-to-r from-teal-400 to-emerald-500 h-3 rounded-full transition-all duration-500 shadow-lg"
                                        ...
                                        {/* Question */}
                                        <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-8 md:p-10 mb-10 border border-white/20 shadow-2xl">
                                        ...
                                        <div className="space-y-6 mb-12">
                                            {currentQuestion?.options.map((option, index) => {
                                                ...
                                                let buttonClasses = "w-full p-6 text-left border-2 rounded-2xl transition-all duration-300 group relative overflow-hidden ";
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        ...
                                                        <div className="relative flex items-center gap-4">
                                                            <div className="w-10 h-10 rounded-full border-2 border-current flex items-center justify-center flex-shrink-0 font-bold">
                                        ...
                                        {/* Feedback */}
                                        {feedbackMessage && (
                                            <div className={`mb-10 p-6 rounded-2xl border backdrop-blur-xl ${
                                        ...
                                        <div className="flex justify-center">
                                            <button
                                                ...
                                                disabled={!isOptionSelected}
                                                className="px-12 py-4 bg-gradient-to-r from-teal-600 to-emerald-600 text-white rounded-xl hover:from-teal-700 hover:to-emerald-700 disabled:from-gray-600 disabled:to-gray-700 disabled:cursor-not-allowed transition-all duration-300 font-semibold text-xl transform hover:scale-105 shadow-2xl disabled:shadow-none"
                                            >
